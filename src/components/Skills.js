  ...
  return (
    <div id="skills">
      ...
      <div className="flex flex-wrap justify-center gap-8 p-4">
        ...
        <div className="w-full sm:w-[calc(50%-2rem)] lg:w-[calc(33.333%-2rem)] p-6 shadow-xl rounded-xl hover:shadow-xl hover:shadow-[Orange] bg-slate-400 text-navbar hover:scale-[1.1] ease-in duration-300">
          <div className="grid grid-cols-2 gap-4 justify-center items-center">
            <div className="m-auto">
